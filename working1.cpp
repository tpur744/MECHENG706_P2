...
void setup() {
  ...
  pidForward.Kp = 75.0;  pidForward.Ki = 0.02;  pidForward.Kd = 0.0;
...
void LED_Setup() {
  pinMode(LED_ORANGE, OUTPUT); pinMode(LED_GREEN, OUTPUT);
  pinMode(LED_BLUE,   OUTPUT); pinMode(LED_RED,   OUTPUT);
  digitalWrite(LED_ORANGE, LOW); digitalWrite(LED_GREEN, LOW);
